  ...
  return (
    <div className=" py-16">
      <div className="container mx-auto text-center mb-12">
        <p className=" text-lg border-b-2 border-gradient-secondary w-fit mx-auto  mb-2">Code Leaders</p>
        <h1 className="text-4xl font-extrabold font-technical">
          The <span className="text-gradient-secondary">Talented</span> People Behind the Scenes
        </h1>
      </div>
      <div className="container mx-auto">
        <div className="flex flex-wrap justify-center gap-8">
          {teamMembers.map((member, index) => (
            <div
              key={index}
              className="w-full mt-16 max-w-xs bg-whitesmoke border-2 border-gradient-secondary glass rounded-3xl
            ...
            >
              <img
                src={member.image}
                alt={member.name}
                className="w-32 h-32 rounded-full object-cover mx-auto -mt-16 border-4 border-gradient-secondart glass shadow-md"
              />
